...
$mhb_rs = Database::search("SELECT * FROM `model_has_brand` WHERE `model_id`='" . $model . "' AND 
`brand_id`='" . $brand . "'");
...
`delivery_fee_other`,`category_id`,`model_has_brand_id`,`condition_id`,`status_id`,`admin_email`) VALUES ('" . $cost . "','" . $qty . "','" . $desc . "','" . $title . "','" . $date . "','" . $dwc . "','" . $doc . "',
'" . $category . "','" . $model_has_brand_id . "','" . $condition . "','" . $status . "','m.thejaka14@gmail.com')");
    ...
    for ($x = 0; $x < $length; $x++) {
        if (isset($_FILES["image" . $x])) {
            ...
            if (in_array($file_extension, $allowed_image_extensions)) {
                ...
                $file_name = "resources//products//mobile_images//" . $title . "_" . $x . "_" . uniqid() . $new_img_extension;
